...
//---------------------------------------------------------
CLineDirection::CLineDirection(void)
{
	//-----------------------------------------------------
...
int CLineDirection::On_Parameter_Changed(CSG_Parameters *pParameters, CSG_Parameter *pParameter)
{
...
int CLineDirection::On_Parameters_Enable(CSG_Parameters *pParameters, CSG_Parameter *pParameter)
{
	if (!SG_STR_CMP(pParameter->Get_Identifier(), "INPUT"))
	{
...
bool CLineDirection::On_Execute(void)
{
	//-----------------------------------------------------
...
//---------------------------------------------------------
inline void CLineDirection::Set_Value(int x, int y, double Value)
{
